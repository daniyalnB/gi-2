...
import { SearchBlogs } from "../../utils/api-routes/api-routes.util";
...
const SearchBG = (props) => {
  ...
  const SearchKeyword = (e) => {
    ...
    SearchBlogs(stringified).subscribe((response) => {
...
export default withRouter(SearchBG);