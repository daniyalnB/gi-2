...
const CreateInsightSheet = (props) => {
    ...
    const publishedMacro = data.filter((val) => val.draft === false);
    ...
    return (
        <>
            <Helmet>
                <title> 
                    Create Insight Sheet - Actionable Insights Admin
                </title>
            </Helmet>
                    ...
                    <div className="row">
                        ...
                        <div className="col-9">
                            ...
                            <div className="createInsightSheet-section">
                                ...
                                <form onSubmit={handleSubmit} id="form" noValidate={insightsheet.isdraft ? true : false}>
...
export default withRouter(CreateInsightSheet);