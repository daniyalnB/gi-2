...
import { addOrUpdateCertification } from "../../../../../utils/api-routes/api-routes.util";
...
const CreateCertification = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      courseTag: certification.courseTag,
  ...
  return (
    <>
      <Helmet>
        <title> 
          Create Certification - Actionable Insights Admin
        </title>
      </Helmet>
                          ...
                          <div className="form-group nogroup">
                            <input 
                              ...
                              onChange={(e) =>
                                setCertification({
                                  ...certification,
                                  courseTag: e.currentTarget.value,
                                })
                              }
                            />
                            <label htmlFor="inputField5" className="floating_label"> Course Tag </label>
                          </div>
                        </div>
                      </div>
                      <div className="row">
...
export default withRouter(CreateCertification);