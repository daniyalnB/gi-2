...
import blogred from "assets/BlogRed.svg";
import vision from "assets/visibility.svg";
import create from "assets/create.png";
import { Helmet } from "react-helmet";
import { GetBlogs } from "../../../../utils/api-routes/api-routes.util";
...
const BlogAdmin = (props) => {
  ...
  return (
    <>
      <Helmet>
        <title> 
          Blog - Actionable Insights Admin
        </title>
      </Helmet>
                              ...
                              <tr key={index}>
                                ...
                                <td>   
                                  <div className="view_icon_users">
                                    <Link
                                      to={`/gi-team/update-blog/${rowData.original.id}`}
                                    >
                                      <img src={vision} />
                                    </Link>
                                  </div>
