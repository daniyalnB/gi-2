...
const UpdateEvent = (props) => {
  ...
  useEffect(() => {
    GetAllEvents().subscribe((response) => {
      if (response.response.Requested_Action) {
        ...
        setData(x);
        const contentBlock = htmlToDraft(x.description == null ? " " : x.description);
        if (contentBlock) {
        ...
        setEvent({
          ...
          virtualSeats: x.virtualSeats,
          startdatetime: moment(x.startdatetime).format("yyyy-MM-DD"),
          type: x.type,
          enddatetime: moment(x.enddatetime).format("yyyy-MM-DD"),
          location: x.location,
          ...
          isdraft: x.draft,
          attendance: x.attendance == null ? "In Person" : x.attendance,
          keywords: x.keywords,
        });
        setEventType(x.type);
        setAttendanceType(x.attendance == null ? "In Person" : x.attendance);
        setTime({
          ...time,
          start: moment(x.startdatetime).format("HH:mm"),
          end: moment(x.enddatetime).format("HH:mm"),
        })
  ...
  return (
    <>
      <Helmet>
        <title> 
          Update Event - Actionable Insights Admin
        </title>
      </Helmet>
              ...
              <div className="createInsightSheet-section">
                <div className="row header">
                  ...
                  <div className="col-3 text-right back">
                    <Link className="bk" to="/gi-team/events">
                ...
                <hr />
                {!loading && (
                  <form onSubmit={handleSubmit} noValidate={event.isdraft ? true : false}>
                          ...
                          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div className="form-group nogroup">
                              <textarea
                                ...
                                id="textField2"
                                className="input-area"
                                value={event.featureddescription}
                                onChange={(e) =>
                                  setEvent({
                                    ...event,
                            ...
                            <div className="form-group nogroup">
                              ...
                              {event.featuredimage ? (
                                <div className="facebook-image-name">
                                  <a href={event.featuredimage} target="_blank">
                                    {event.featuredimage.name ? (
                                      `${"   " + event.featuredimage.name}`
                                    ) : (
                                      parse(`${event.featuredimage.replace("https://getinsights2-data.s3.amazonaws.com/", "")}`)
                                    )}
                                  </a>
                                </div>
                              ) : (
                          ...
                          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div className="form-group nogroup">
                              ...
                              {event.facebookogimage ? (
                                <div className="facebook-image-name">
                                  <a href={event.facebookogimage} target="_blank">
                                    {event.facebookogimage.name ? (
                                      `${"   " + event.facebookogimage.name}`
                                    ) : (
                                      parse(`${event.facebookogimage.replace("https://getinsights2-data.s3.amazonaws.com/", "")}`)
                                    )}
                                  </a>
                                </div>
                              ) : (
