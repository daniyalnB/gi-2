...
const FormElementAfterPay = (props) => {
  ...
  const url = `${
    window.location.hostname === "localhost"
      ? "http://localhost:8000/buy-certification"
      : window.location.hostname === "reactdev.getinsights.org"
      ? "https://reactdev.getinsights.org/buy-certification"
      : "https://getinsights.org/buy-certification"
  }`;
...
const BuyCertification = (props) => {
  ...
  useEffect(() => {
    if (localStorage.getItem("certification_data") == null) {
      ...
      setCertificationExtras(x.certificationExtras);
      setPropsData({
				...propsData,
				type: x.type,
				path: x.path,
  ...
  const BuyCertificationAfterPay = () => {
    setPageLoading(true);
    ...
    setTimeout(() => {
      ...
      BuyCertificationAPI(x.couponCode == "" ? stringified1 : stringified2, objContactInformationForOrderDTO).subscribe((response) => {
        if (response.response.Requested_Action) {
  ...
  return (
    <>
      <SEO
        title="Certification Checkout - Actionable Insights"
                    ...
                    <div className="order-info">
                          ...
                          <div className="col-6">
                            ...
                            {!couponLoading && (
                              <button
                                ...
                                onClick={handleSubmitCouponForCertification}
                              >
                                Apply Coupon
                              </button>
                            )}
                      ...
                      <div className="insighter-points">
                        <div className="row">
                          ...
                          <form
                            onSubmit={handleInsighterPointsForCertification}
                            ...
                            <div className="col-6">
                              ...
                              {!IPLoading && (
                                <button
                                  ...
                                  type="submit"
                                  disabled={
                                    insighterpointstouse <= 0 ? true : false
                                  }
                                >
                                  Apply
                                </button>
